...
import 'package:whatsargazo/screens/bottom_bar.dart';
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => const BottomBar()), // Crea una nueva instancia de HomeScreen y la agrega como una nueva ruta
      );
      },
      child: SizedBox(
        height: 64,
